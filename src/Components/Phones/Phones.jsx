...
export default function Phones() {
    let { phonse } = useContext(mediaContext)
    ...
    return <>
        ...
        <div className="container mt-5">
            ...
            <div className="row g-4">
                ...
                {!phonse ? <div className='h-100 d-flex justify-content-center align-items-center'><div class="spinner-grow  " role="status">
                    <span className="visually-hidden">Loading...</span>
                </div></div> :
                    phonse?.map((item, index) => (
