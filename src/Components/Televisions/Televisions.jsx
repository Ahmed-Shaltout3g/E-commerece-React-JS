...
export default function Televisions() {
    let { tvs } = useContext(mediaContext)
    ...
    return <>
        ...
        <div className="container mt-5">
            ...
            <div className="row g-4">
                ...
                {!tvs ? <div className='h-100 d-flex justify-content-center align-items-center'><div class="spinner-grow  " role="status">
                        ...
                        <div key={index} className="col-md-3 grid-box   ">
                            <div className='bg-white  border-1 border'>
                                ...
                                <div className="d-flex justify-content-between px-3 mt-2">
                                    <p className='ps-2'><span className='ps-2  color text-danger rounded-5 px-2 py-1'>{item.discount ? `-${parseFloat(item.discount?.slice(0, 3))}%` : 'NO discount'}</span></p>
