...
export default function Cameras() {
    let { cameras } = useContext(mediaContext)
    ...
    return <>
        ...
        {cameras?.length ? <div className="container mt-5">

            <div className="row g-4">

                {!cameras ? <div className='h-100 d-flex justify-content-center align-items-center'><div class="spinner-grow  " role="status">
