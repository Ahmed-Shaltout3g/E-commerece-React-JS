...
export default function Home() {
    ...
    return <>
                    ...
                    <div className="col-md-2  ">
                        <div className={homeStyle.login}>
                            <div className='d-flex'>
                                ...
                                <p className='h6'>Hi, user<br /> let's get start</p>
                            </div>
                            <Link to='register'><button className='btn mt-3 w-100 py-1 btn-primary'>Join Now</button></Link>
                            <Link to='login' ><button className='btn text-primary mt-3 w-100 py-1 btn-light '>Log in</button></Link>
        ...
        <section className='mt-5'>
            <div className="container  ">
                <div className="row ">
                    <div className="col-md-3 bg-white  border-1 border pt-2 pb-5">
                    ...
                    <div className="col-md-9 bg-white  text-center">
                        <div className="row  ">
