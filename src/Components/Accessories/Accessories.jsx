...
export default function Accessories() {
    let { accessories } = useContext(mediaContext)
    ...
    return <>
        ...
        {accessories?.length ? <div className="container mt-5">

            <div className="row g-4">

                {!accessories ? <div className='h-100 d-flex justify-content-center align-items-center'><div class="spinner-grow  " role="status">
